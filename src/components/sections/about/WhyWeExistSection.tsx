    ...
    <section className="py-16 md:py-24 px-6 md:px-8 max-w-[1400px] mx-auto">
      ...
      >
        <motion.div variants={itemVariants} className="md:w-1/3 shrink-0">
          <h2 className="font-display-lg text-4xl sm:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight">
            Why We Exist.
          </h2>
        </motion.div>

        <motion.div variants={itemVariants} className="md:w-2/3 space-y-8">
          <p className="font-display-md text-xl sm:text-2xl text-slate-900 dark:text-white font-medium leading-relaxed">
          ...
          <p className="font-body-lg text-lg text-slate-600 dark:text-zinc-400 leading-relaxed">
          ...
          <div className="pt-6 grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
              <div className="flex items-center gap-2 font-bold text-slate-900 dark:text-white text-lg mb-2">
                <span className="material-symbols-outlined text-indigo-600 dark:text-indigo-400">code_blocks</span>
                Zero Technical Debt
              </div>
