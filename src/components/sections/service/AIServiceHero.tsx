  ...
  return (
    <section className="relative max-w-[1280px] mx-auto px-6 md:px-8 pt-space-16 pb-space-32 min-h-[716px] flex items-center">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-space-12 items-center w-full z-10">
        ...
        >
          <motion.div variants={itemVariants} className="flex items-center space-x-2 text-text-secondary font-caption text-caption mb-4">
          ...
          <motion.h1 variants={itemVariants} className="font-display-xl-mobile text-3xl sm:text-4xl md:text-5xl xl:font-display-xl xl:text-display-xl text-on-surface">
          ...
          <motion.p variants={itemVariants} className="font-body-lg text-sm sm:text-base md:text-lg xl:text-body-lg text-text-secondary max-w-xl leading-relaxed">
