  ...
  return (
    <section className="py-space-32 bg-slate-50/80 border-y border-slate-200/80 overflow-hidden">
      <div className="px-6 md:px-8 max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          <h3 className="font-display-md text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-900 mb-8">
          ...
          <ul className="space-y-4">
            {deliverables.map((item, idx) => (
              ...
              >
                <span
                  className="material-symbols-outlined text-indigo-600 text-[24px] group-hover:scale-110 transition-transform"
