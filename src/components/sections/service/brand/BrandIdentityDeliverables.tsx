    ...
    <section className="py-space-32 px-6 md:px-8 bg-slate-50/60">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <span className="text-indigo-600 font-caption text-xs uppercase tracking-widest mb-space-4 block font-bold">The Package</span>
            <h2 className="font-display-lg text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-900 mb-space-8">What You Receive</h2>
            <ul className="space-y-6">
              {items.map((item, idx) => (
                ...
                >
                  <span className="material-symbols-outlined text-indigo-600 text-[24px]" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                  <div>
                    <h5 className="font-heading-md text-base sm:text-lg font-bold text-slate-900">{item.title}</h5>
          ...
          >
            ...
            >
              <div className="text-xs font-semibold text-slate-400 mb-4 uppercase tracking-wider">Color Palette</div>
            ...
            >
              <div className="text-xs font-semibold text-slate-400 mb-4 uppercase tracking-wider">Typography</div>
              <div className="space-y-2">
                <div className="font-display-md text-3xl font-extrabold text-slate-900 leading-none">Aa</div>
            ...
            >
              <div className="text-xs font-semibold text-slate-400 mb-4 uppercase tracking-wider">Iconography Library</div>
              <div className="grid grid-cols-6 gap-4 items-center justify-items-center">
                {["analytics", "language", "security", "hub", "auto_graph", "diversity_3"].map((icon, i) => (
                  <motion.span 
                    key={i} 
