      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="p-8 sm:p-12 lg:p-16 lg:w-1/2 flex flex-col justify-center">
            <span className="text-indigo-400 font-caption text-xs font-semibold uppercase tracking-widest mb-space-4 block">
              Featured Transformation
            </span>
            <h2 className="text-white font-display-lg text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-space-6 leading-tight">
              Cloud Platform Complete Rebrand
            </h2>
            <div className="flex items-center gap-6 mb-space-8">
              <div className="text-white text-4xl sm:text-5xl font-extrabold text-indigo-400">
                300%
              </div>
              <div className="text-slate-300 text-sm sm:text-base max-w-[170px] leading-snug">
