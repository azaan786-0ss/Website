    ...
    <section className="py-space-32 px-6 md:px-8 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
        ...
        <motion.div
          ...
          className="flex-1"
        >
          <h2 className="font-heading-lg text-2xl sm:text-3xl font-extrabold text-slate-900 mb-space-8">
          ...
          <ul className="space-y-6">
            {deliverables.map((item, idx) => (
              ...
              >
                <span
                  className="material-symbols-outlined text-indigo-600 mt-1 text-[24px]"
        ...
        >
          <div className="bg-slate-50 p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-sm">
            <h4 className="font-caption text-xs uppercase font-bold text-slate-400 tracking-widest mb-6">
              Expertise Stack
            </h4>
