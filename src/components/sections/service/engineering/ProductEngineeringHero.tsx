...
export function ProductEngineeringHero() {
  ...
  return (
    <section className="relative pt-6 sm:pt-10 pb-16 px-6 md:px-8 overflow-hidden bg-slate-50/70">
      ...
      <div className="max-w-[1280px] mx-auto relative z-10">
        ...
        <div className="w-full flex items-center justify-start text-left mb-6">
          <div className="flex items-center space-x-2 text-slate-500 font-caption text-xs sm:text-sm">
            ...
            <span className="material-symbols-outlined text-[16px]">chevron_right</span>
            <span className="text-slate-900 font-medium">Product Engineering</span>
          </div>
        </div>
        ...
        >
          <motion.h1
            ...
            className="animate-shine bg-clip-text text-transparent bg-[linear-gradient(110deg,#0f172a,45%,#6366f1,55%,#0f172a)] bg-[length:200%_100%] font-display-xl text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 max-w-5xl mx-auto mb-6 tracking-tight leading-tight"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="font-body-lg text-base sm:text-lg text-slate-600 max-w-3xl mx-auto mb-8 leading-relaxed"
          >
        ...
        >
          {metrics.map((m, idx) => (
            ...
            >
              <span className="material-symbols-outlined text-indigo-600 mb-2 text-2xl group-hover:scale-110 transition-transform">
                {m.icon}
              </span>
              <div className="font-display-md text-2xl sm:text-3xl font-extrabold text-slate-900 mb-1">
                {m.value}
              </div>
