  ...
  return (
    <section className="py-space-32 bg-slate-50/85 border-y border-slate-200/80 overflow-hidden">
      <div className="px-6 md:px-8 max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          <h2 className="font-display-md text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-900 mb-8">
            Key Deliverables
          </h2>
          <ul className="space-y-4">
            {deliverables.map((item, idx) => (
              ...
              >
                <span
                  className="material-symbols-outlined text-indigo-600 text-[24px] mt-0.5 group-hover:scale-110 transition-transform"
        ...
        >
          <h3 className="font-caption text-xs uppercase font-bold text-slate-400 tracking-widest mb-6 text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-center">
            {tools.map((tool, idx) => (
              ...
              >
                <span
                  className="material-symbols-outlined text-indigo-600 text-[18px]"
                  style={{ fontVariationSettings: "'FILL' 1" }}
                >
                  {tool.icon}
                </span>
          ...
          <div className="mt-8 p-6 bg-indigo-50/60 rounded-2xl border border-indigo-100">
            <p className="text-slate-700 text-sm italic leading-relaxed">
              "We leverage enterprise-grade telemetry to ensure data-driven decision making at every
