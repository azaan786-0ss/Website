    ...
    <section className="relative pt-6 sm:pt-10 pb-16 px-6 md:px-8 max-w-[1280px] mx-auto overflow-hidden dark:bg-[#050505] transition-colors duration-300">
      ...
      <div className="relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="material-symbols-outlined text-[16px]">chevron_right</span>
              <span className="text-slate-900 dark:text-[#fafafa] font-medium">Process Automation</span>
            </motion.div>
          ...
          <motion.div
            ...
            className="lg:col-span-5 relative h-[380px] sm:h-[420px] w-full rounded-3xl overflow-hidden border border-slate-200/80 dark:border-[#262626] bg-white/80 dark:bg-[#111111]/80 backdrop-blur-md shadow-xl shadow-indigo-500/5 dark:shadow-[#4f46e5]/10 p-6 flex flex-col justify-between group"
          >
            {/* Ambient inner glow */}
            <div className="absolute -right-10 -bottom-10 w-64 h-64 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" />

            <div className="flex items-center justify-between border-b border-slate-100 dark:border-[#262626] pb-4">
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-emerald-500 animate-pulse" />
                <span className="font-mono text-xs font-semibold text-slate-700 dark:text-[#a3a3a3] uppercase tracking-wider">
            ...
            <div className="space-y-4 my-auto">
              <div className="p-4 bg-slate-50 dark:bg-[#050505] rounded-2xl border border-slate-100 dark:border-[#262626] flex items-center justify-between group-hover:border-indigo-200 dark:group-hover:border-[#c084fc] transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-indigo-100 dark:bg-[#4f46e5]/20 text-indigo-600 dark:text-[#c084fc] flex items-center justify-center font-bold">
                    <span className="material-symbols-outlined text-[20px]">smart_toy</span>
                  </div>
                  <div>
                    <div className="text-sm font-bold text-slate-900 dark:text-[#fafafa]">AI Document Parser</div>
                    <div className="text-xs text-slate-500 dark:text-[#a3a3a3]">Invoices & Contracts</div>
                  </div>
                </div>
              ...
              <div className="p-4 bg-slate-50 dark:bg-[#050505] rounded-2xl border border-slate-100 dark:border-[#262626] flex items-center justify-between group-hover:border-indigo-200 dark:group-hover:border-[#c084fc] transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-slate-900 dark:text-[#fafafa]">CRM & ERP Data Sync</div>
                    <div className="text-xs text-slate-500 dark:text-[#a3a3a3]">Real-time Webhook Pipeline</div>
                  </div>
                </div>
            ...
            <div className="pt-3 border-t border-slate-100 dark:border-[#262626] flex items-center justify-between text-xs text-slate-500 dark:text-[#a3a3a3] font-mono">
              <span>Status: Operational</span>
              <span className="text-indigo-600 dark:text-[#c084fc] font-semibold">Zero Human Lag</span>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-16 pt-8 border-t border-slate-200 dark:border-[#262626]"
        >
          {metrics.map((item, idx) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#111111] p-6 sm:p-8 rounded-2xl border border-slate-200/80 dark:border-[#262626] shadow-sm hover:shadow-xl hover:border-indigo-400 dark:hover:border-[#c084fc] hover:shadow-indigo-500/10 dark:hover:shadow-[#c084fc]/10 transition-all duration-300 flex flex-col items-center text-center group"
            >
              <span className="text-indigo-600 dark:text-[#c084fc] font-display-md text-3xl sm:text-4xl font-extrabold mb-2 group-hover:scale-105 transition-transform duration-300">
                {item.value}
              </span>
              <span className="text-slate-500 dark:text-[#a3a3a3] font-caption text-xs sm:text-sm uppercase tracking-wider font-medium">
                {item.label}
              </span>
            </motion.div>
          ))}
