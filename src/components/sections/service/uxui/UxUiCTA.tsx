...
export function UxUiCTA() {
  return (
    <section className="bg-indigo-600 py-space-24 relative overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-8 text-center text-white relative z-10">
        <motion.h2
          ...
          className="font-display-lg text-3xl sm:text-4xl md:text-5xl font-extrabold mb-space-6 tracking-tight"
        >
        ...
        <motion.p
          ...
          className="text-indigo-100 font-body-lg text-base sm:text-lg mb-space-12 max-w-xl mx-auto leading-relaxed"
        >
        ...
        >
          <Link to="/start-project">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-white text-indigo-600 px-8 sm:px-12 py-4 rounded-xl font-bold text-base sm:text-lg shadow-xl shadow-indigo-900/20 hover:shadow-2xl transition-all"
            >
