...
export function ApiDevelopmentDetail() {
  ...
  return (
    <div className="bg-[#FAFAFC] dark:bg-[#050505] text-on-surface dark:text-[#fafafa] antialiased overflow-x-hidden selection:bg-primary-fixed selection:text-on-primary-fixed min-h-screen font-body-md flex flex-col transition-colors duration-300">
