...
export function DataAnalyticsDetail() {
  ...
  return (
    <div className="bg-background text-on-background antialiased overflow-x-clip selection:bg-primary-fixed selection:text-on-primary-fixed min-h-screen font-body-md flex flex-col">
