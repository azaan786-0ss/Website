...
export function ProcessAutomationDetail() {
  ...
  return (
    <div className="bg-surface text-on-surface dark:bg-[#050505] dark:text-[#fafafa] antialiased overflow-x-hidden selection:bg-primary-fixed selection:text-on-primary-fixed min-h-screen font-body-md flex flex-col transition-colors duration-300">
