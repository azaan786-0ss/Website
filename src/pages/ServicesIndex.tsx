        ...
        <section className="max-w-7xl mx-auto px-6 md:px-8 pb-space-32 space-y-space-24">
          ...
          <div className="fadeUpReveal delay-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-space-6">
              <div className="border border-border rounded-lg p-space-6 bg-surface hover:border-primary hover:shadow-[0_2px_8px_rgba(17,19,24,0.06)] transition-all group">
                <span className="material-symbols-outlined text-primary mb-space-4" style={{ fontVariationSettings: "'FILL' 1" }}>view_quilt</span>
                <h3 className="font-heading-md text-heading-md text-on-surface mb-space-2">UX/UI Design</h3>
              ...
              <div className="border border-border rounded-lg p-space-6 bg-surface hover:border-primary hover:shadow-[0_2px_8px_rgba(17,19,24,0.06)] transition-all group">
                ...
                <h3 className="font-heading-md text-heading-md text-on-surface mb-space-2">Product Strategy</h3>
              ...
              <div className="border border-border rounded-lg p-space-6 bg-surface hover:border-primary hover:shadow-[0_2px_8px_rgba(17,19,24,0.06)] transition-all group">
                ...
                <h3 className="font-heading-md text-heading-md text-on-surface mb-space-2">Brand Identity</h3>
          ...
          <div className="fadeUpReveal delay-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-space-6">
              <Link to="/services/web-design" className="block border border-border rounded-lg p-space-6 bg-surface hover:border-primary hover:shadow-[0_2px_8px_rgba(17,19,24,0.06)] transition-all group cursor-pointer">
                <span className="material-symbols-outlined text-primary mb-space-4" style={{ fontVariationSettings: "'FILL' 1" }}>code</span>
                <h3 className="font-heading-md text-heading-md text-on-surface mb-space-2 group-hover:text-primary transition-colors">Web Application</h3>
                <p className="font-body-md text-body-md text-text-secondary">Scalable and performant web solutions built on modern stacks.</p>
              </Link>
              <Link to="/services/mobile-app" className="block border border-border rounded-lg p-space-6 bg-surface hover:border-primary hover:shadow-[0_2px_8px_rgba(17,19,24,0.06)] transition-all group cursor-pointer">
                <span className="material-symbols-outlined text-primary mb-space-4" style={{ fontVariationSettings: "'FILL' 1" }}>smartphone</span>
                <h3 className="font-heading-md text-heading-md text-on-surface mb-space-2 group-hover:text-primary transition-colors">Mobile App Development</h3>
                <p className="font-body-md text-body-md text-text-secondary">Native and cross-platform mobile solutions for intuitive user experiences.</p>
              </Link>
              <Link to="/services/ai-solutions" className="block border border-border rounded-lg p-space-6 bg-surface hover:border-primary hover:shadow-[0_2px_8px_rgba(17,19,24,0.06)] transition-all group cursor-pointer">
                <span className="material-symbols-outlined text-primary mb-space-4" style={{ fontVariationSettings: "'FILL' 1" }}>smart_toy</span>
                <h3 className="font-heading-md text-heading-md text-on-surface mb-space-2 group-hover:text-primary transition-colors">AI Solutions</h3>
                <p className="font-body-md text-body-md text-text-secondary">Integrating machine learning models and LLMs to automate processes.</p>
              </Link>
            </div>
          </div>
          ...
          <div className="fadeUpReveal delay-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-space-6">
              <div className="border border-border rounded-lg p-space-6 bg-surface hover:border-primary hover:shadow-[0_2px_8px_rgba(17,19,24,0.06)] transition-all group">
                ...
                <h3 className="font-heading-md text-heading-md text-on-surface mb-space-2">Data Analytics</h3>
              ...
              <div className="border border-border rounded-lg p-space-6 bg-surface hover:border-primary hover:shadow-[0_2px_8px_rgba(17,19,24,0.06)] transition-all group">
                ...
                <h3 className="font-heading-md text-heading-md text-on-surface mb-space-2">Process Automation</h3>
              ...
              <div className="border border-border rounded-lg p-space-6 bg-surface hover:border-primary hover:shadow-[0_2px_8px_rgba(17,19,24,0.06)] transition-all group">
                ...
                <h3 className="font-heading-md text-heading-md text-on-surface mb-space-2">Performance Optimization</h3>
